...
var pokemon_autocomplete = Object.keys(pokedex.pokemon);
var pokemon_url = Object.keys(pokedex.pokemon);

for(let i=0; i<pokemon_autocomplete.length; i++)
{
	pokemon_autocomplete[i] = pokedex.pokemon[pokemon_autocomplete[i]].species;
}